...
#read admin boundary
adm <- st_read("adm/el_nido_adm_utm.shp", quiet = TRUE)
...
training_points <- st_read("rois/el_nido_roi_centroids.shp", quiet = TRUE)
...
#export tif file
writeRaster(veg.pr, "el_nido_veg2019.tif", overwrite=TRUE)
