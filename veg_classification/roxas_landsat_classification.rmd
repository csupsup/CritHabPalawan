...
#read admin boundary
adm <- st_read("adm/roxas_adm_utm.shp", quiet = TRUE)
...
training_points <- st_read("rois/roxas_roi_centroids.shp", quiet = TRUE)
...
profiles <- df %>% 
  ...
  na.omit() %>% 
  group_by(id) %>% 
  summarise(roxas_b10 = mean(roxas_b10),
            roxas_b11 = mean(roxas_b11),
            roxas_b12 = mean(roxas_b12),
            roxas_b2 = mean(roxas_b2),
            roxas_b3 = mean(roxas_b3),
            roxas_b4 = mean(roxas_b4),
            roxas_b5 = mean(roxas_b5),
            roxas_b6 = mean(roxas_b6),
            roxas_b7 = mean(roxas_b7),
            roxas_b8 = mean(roxas_b8),
            roxas_b8a = mean(roxas_b8a)) %>% 
...
#export tif file
writeRaster(veg.pr, "roxas_veg2019.tif", overwrite=TRUE)
