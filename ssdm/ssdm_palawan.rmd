...
#install packages
list.of.packages <- c("devtools", "SSDM", "raster", "sp", "sf", "ggplot2", "sdmpredictors", "ecodist", "spThin")
...
spp.fl <- load_occ(path = "spp_fl/", envi, Xcol = 'Longitude', Ycol='Latitude', Spcol = 'Species', sep=",", GeoRes = FALSE, header = TRUE)
#check data
plot(Envi$pal_esalc_2019)
points(spp$Longitude, spp$Latitude)
#perform stacked species distribution modeling
SSDM <- stack_modelling(c('MAXENT', 'CTA', 'GLM', 'RF', 'SVM'), spp.fl, envi.fl, Xcol = 'Longitude', Ycol = 'Latitude', verbose = TRUE, metric = "LW", ensemble.metric = "AUC", ensemble.thresh = 0, rep = 1, Spcol = "Species", method = 'pSSDM', save = TRUE, path = getwd(), tmp = TRUE)
